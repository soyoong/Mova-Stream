...
export default function Home() {
  return (
    <div className="main-container">
      <div className="main-header anim" styles="--delay: 0s">
        Discover
      </div>
      <div className="main-blogs">
        <div className="main-blog anim" styles="--delay: .1s">
        ...
        <div className="main-blog anim" styles="--delay: .2s">
          <div className="main-blog__title">
      ...
      <div className="small-header anim" styles="--delay: .3s">
        Most Watched
      </div>
      <div className="videos">
        <div className="video anim" styles="--delay: .4s">
        ...
        <div className="video anim" styles="--delay: .5s">
        ...
        <div className="video anim" styles="--delay: .6s">
        ...
        <div className="video anim" styles="--delay: .7s">
        ...
        <div className="video-stream">
          ...
          <div className="video-detail">
            <div className="video-content">
              <div className="video-p-wrapper anim" styles="--delay: .1s">
              ...
              <div className="video-p-title anim" styles="--delay: .2s">
                Basic how to ride your Skateboard
              </div>
              <div className="video-p-subtitle anim" styles="--delay: .3s">
              ...
              <div className="video-p-subtitle anim" styles="--delay: .4s">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
        ...
        <div className="chat-stream">
          <div className="chat">
            ...
            <div className="message-container">
              <div className="message anim" styles="--delay: .1s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="message anim" styles="--delay: .2s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="message anim" styles="--delay: .3s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="message anim" styles="--delay: .4s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="message anim" styles="--delay: .5s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
              ...
              <div className="message anim" styles="--delay: .6s">
                <div className="author-img__wrapper video-author video-p">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
            ...
            <div className="chat-footer anim" styles="--delay: .1s">
              <input type="text" placeholder="Write your message" />
            </div>
          </div>
          <div className="chat-vid__container">
            <div className="chat-vid__title anim" styles="--delay: .3s">
              Related Videos
            </div>
            <div className="chat-vid anim" styles="--delay: .4s">
            ...
            <div className="chat-vid anim" styles="--delay: .5s">
              <div className="chat-vid__wrapper">
                <img
                  className="chat-vid__img"
            ...
            <div className="chat-vid__button anim" styles="--delay: .6s">
